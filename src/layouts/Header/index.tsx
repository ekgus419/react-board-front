...
import { AUTH_PATH, BOARD_DETAIL_PATH, BOARD_PATH, BOARD_UPDATE_PATH, BOARD_WRITH_PATH, MAIN_PATH, SEARCH_PATH, USER_PATH } from 'constant';
...
export default function Header() {
  ...
  const UploadButton = () => {
    ...
    const onUploadButtonClickHandler = async () => {
      ...
      const isWirterPage = pathname === BOARD_PATH() + '/' + BOARD_WRITH_PATH();
      if (isWirterPage) {
  ...
  useEffect(() => {
    ...
    const isBoardWritePage = pathname.startsWith(BOARD_PATH() + '/' + BOARD_WRITH_PATH());
    ...
    <div id="header">
      <div className='header-container'>
        <div className='header-left-box' onClick={onLogoClickHandler}>
          ...
          <div className='header-log'>{'My Blog'}</div>
        </div>
